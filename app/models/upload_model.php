...
class Upload_model extends CI_Model{
  ...
  function __construct(){
    ...
    $this->original_path 	= realpath(APPPATH.'../uploads/temp');
    $this->resized_path 	= realpath(APPPATH.'../uploads/news_images');
    $this->thumbs_path 		= realpath(APPPATH.'../uploads/news_images_thumbnail');
  }
